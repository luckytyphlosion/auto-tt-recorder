...
def check_suitable_ghost(legacy_wr_entry):
    ...
    try:
        ...
        print(f"legacy_wr_entry: {legacy_wr_entry}, updated_legacy_wr_lb_ignoring_vehicle_modifier: {updated_legacy_wr_lb_ignoring_vehicle_modifier}")
